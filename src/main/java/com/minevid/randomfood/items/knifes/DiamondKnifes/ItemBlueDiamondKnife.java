 ...
 */
public class ItemBlueDiamondKnife extends Item{
    public ItemBlueDiamondKnife(){
        setRegistryName("bluediamondknife");
        setUnlocalizedName(References.MOD_ID + ".bluediamondknife");
