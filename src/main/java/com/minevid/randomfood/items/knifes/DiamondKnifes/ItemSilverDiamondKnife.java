 ...
 */
public class ItemSilverDiamondKnife extends Item{
    public ItemSilverDiamondKnife(){
        setRegistryName("silverdiamondknife");
        setUnlocalizedName(References.MOD_ID + ".silverdiamondknife");
