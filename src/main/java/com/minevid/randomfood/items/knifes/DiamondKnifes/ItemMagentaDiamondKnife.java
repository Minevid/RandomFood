 ...
 */
public class ItemMagentaDiamondKnife extends Item{
    public ItemMagentaDiamondKnife(){
        setRegistryName("magentadiamondknife");
        setUnlocalizedName(References.MOD_ID + ".magentadiamondknife");
