 ...
 */
public class ItemWhiteIronKnife extends Item {
    public ItemWhiteIronKnife() {
        setRegistryName("whiteironknife");
        setUnlocalizedName(References.MOD_ID + ".whiteironknife");
