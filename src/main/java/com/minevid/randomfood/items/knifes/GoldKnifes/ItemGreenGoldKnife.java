 ...
 */
public class ItemGreenGoldKnife extends Item{
    public ItemGreenGoldKnife(){
        setRegistryName("greengoldknife");
        setUnlocalizedName(References.MOD_ID + ".greengoldknife");
