 ...
 */
public class ItemPurpleGoldKnife extends Item {
    public ItemPurpleGoldKnife(){
        setRegistryName("purplegoldknife");
        setUnlocalizedName(References.MOD_ID + ".purplegoldknife");
