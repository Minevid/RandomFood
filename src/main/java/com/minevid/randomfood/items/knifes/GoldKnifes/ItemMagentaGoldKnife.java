 ...
 */
public class ItemMagentaGoldKnife extends Item {
    public ItemMagentaGoldKnife(){
        setRegistryName("magentagoldknife");
        setUnlocalizedName(References.MOD_ID + ".magentagoldknife");
