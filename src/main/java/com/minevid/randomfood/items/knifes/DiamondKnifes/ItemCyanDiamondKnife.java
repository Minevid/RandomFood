 ...
 */
public class ItemCyanDiamondKnife extends Item{
    public ItemCyanDiamondKnife(){
        setRegistryName("cyandiamondknife");
        setUnlocalizedName(References.MOD_ID + ".cyandiamondknife");
