 ...
 */
public class ItemLightBlueGoldKnife extends Item{
    public ItemLightBlueGoldKnife(){
        setRegistryName("lightbluegoldknife");
        setUnlocalizedName(References.MOD_ID + ".lightbluegoldknife");
        GameRegistry.register(this);
        this.setCreativeTab(CreativeTabRF.RF_TAB_KNIFE);
        setMaxStackSize(References.MaxStackSizeTool);
        setNoRepair();
        setMaxDamage(References.MaxDamageGoldTool);
    }
    @Override
