 ...
 */
public class ItemBlackGoldKnife extends Item {
    public ItemBlackGoldKnife() {
        setRegistryName("blackgoldknife");
        setUnlocalizedName(References.MOD_ID + ".blackgoldknife");
