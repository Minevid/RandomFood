 ...
 */
public class ItemPurpleIronKnife extends Item {
    public ItemPurpleIronKnife() {
        setRegistryName("purpleironknife");
        setUnlocalizedName(References.MOD_ID + ".purpleironknife");
