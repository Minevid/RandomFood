 ...
 */
public class ItemWhiteGoldKnife extends Item{
    public ItemWhiteGoldKnife(){
        setRegistryName("whitegoldknife");
        setUnlocalizedName(References.MOD_ID + ".whitegoldknife");
