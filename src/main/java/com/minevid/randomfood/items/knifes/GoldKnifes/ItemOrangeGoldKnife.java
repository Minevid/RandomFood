 ...
 */
public class ItemOrangeGoldKnife extends Item{
    public ItemOrangeGoldKnife(){
        setRegistryName("orangegoldknife");
        setUnlocalizedName(References.MOD_ID + ".orangegoldknife");
