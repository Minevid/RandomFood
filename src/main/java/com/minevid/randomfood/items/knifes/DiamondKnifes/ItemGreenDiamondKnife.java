 ...
 */
public class ItemGreenDiamondKnife extends Item{
    public ItemGreenDiamondKnife(){
        setRegistryName("greendiamondknife");
        setUnlocalizedName(References.MOD_ID + ".greendiamondknife");
