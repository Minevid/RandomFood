 ...
 */
public class ItemBrownGoldKnife extends Item{
    public ItemBrownGoldKnife(){
        setRegistryName("browngoldknife");
        setUnlocalizedName(References.MOD_ID + ".browngoldknife");
