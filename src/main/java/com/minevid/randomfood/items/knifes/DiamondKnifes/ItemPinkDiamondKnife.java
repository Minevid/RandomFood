 ...
 */
public class ItemPinkDiamondKnife extends Item {
    public ItemPinkDiamondKnife(){
        setRegistryName("pinkdiamondknife");
        setUnlocalizedName(References.MOD_ID + ".pinkdiamondknife");
