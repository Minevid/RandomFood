 ...
 */
public class ItemMagentaIronKnife extends Item {

    public ItemMagentaIronKnife(){
        setRegistryName("magentaironknife");
        setUnlocalizedName(References.MOD_ID + ".magentaironknife");
