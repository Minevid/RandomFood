 ...
 */
public class ItemLimeDiamondKnife extends Item {
    public ItemLimeDiamondKnife(){
        setRegistryName("limediamondknife");
        setUnlocalizedName(References.MOD_ID + ".limediamondknife");
