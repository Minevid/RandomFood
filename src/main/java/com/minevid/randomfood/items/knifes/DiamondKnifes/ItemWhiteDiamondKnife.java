 ...
 */
public class ItemWhiteDiamondKnife extends Item{
    public ItemWhiteDiamondKnife(){
        setRegistryName("whitediamondknife");
        setUnlocalizedName(References.MOD_ID + ".whitediamondknife");
