 ...
 */
public class ItemBlackIronKnife extends Item{

    public ItemBlackIronKnife(){
        setRegistryName("blackironknife");
        setUnlocalizedName(References.MOD_ID + ".blackironknife");
