 ...
 */
public class ItemPurpleDiamondKnife extends Item {
    public ItemPurpleDiamondKnife(){
        setRegistryName("purplediamondknife");
        setUnlocalizedName(References.MOD_ID + ".purplediamondknife");
