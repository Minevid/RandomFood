 ...
 */
public class ItemOrangeDiamondKnife extends Item{
    public ItemOrangeDiamondKnife(){
        setRegistryName("orangediamondknife");
        setUnlocalizedName(References.MOD_ID + ".orangediamondknife");
