 ...
 */
public class ItemYellowIronKnife extends Item {
    public ItemYellowIronKnife() {
        setRegistryName("yellowironknife");
        setUnlocalizedName(References.MOD_ID + ".yellowironknife");
