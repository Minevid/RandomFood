 ...
 */
public class ItemGrayDiamondKnife extends Item{
    public ItemGrayDiamondKnife(){
        setRegistryName("graydiamondknife");
        setUnlocalizedName(References.MOD_ID + ".graydiamondknife");
