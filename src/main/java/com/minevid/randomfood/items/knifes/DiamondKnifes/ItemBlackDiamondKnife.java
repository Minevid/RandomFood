 ...
 */
public class ItemBlackDiamondKnife extends Item{
    public ItemBlackDiamondKnife(){
        setRegistryName("blackdiamondknife");
        setUnlocalizedName(References.MOD_ID + ".blackdiamondknife");
