 ...
 */
public class ItemRedDiamondKnife extends Item{
    public ItemRedDiamondKnife(){
        setRegistryName("reddiamondknife");
        setUnlocalizedName(References.MOD_ID + ".reddiamondknife");
