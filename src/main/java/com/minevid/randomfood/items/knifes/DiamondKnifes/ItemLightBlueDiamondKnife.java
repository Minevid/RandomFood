 ...
 */
public class ItemLightBlueDiamondKnife extends Item{
    public ItemLightBlueDiamondKnife(){
        setRegistryName("lightbluediamondknife");
        setUnlocalizedName(References.MOD_ID + ".lightblueknife");
        GameRegistry.register(this);
        this.setCreativeTab(CreativeTabRF.RF_TAB_KNIFE);
        setMaxStackSize(References.MaxStackSizeTool);
        setNoRepair();
        setMaxDamage(References.MaxDamageDiamondTool);
    }
    @Override
