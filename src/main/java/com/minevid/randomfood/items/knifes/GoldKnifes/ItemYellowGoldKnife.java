 ...
 */
public class ItemYellowGoldKnife extends Item{
    public ItemYellowGoldKnife(){
        setRegistryName("yellowgoldknife");
        setUnlocalizedName(References.MOD_ID + ".yellowgoldknife");
