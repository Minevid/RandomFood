 ...
 */
public class ItemYellowDiamondKnife extends Item{
    public ItemYellowDiamondKnife(){
        setRegistryName("yellowdiamondknife");
        setUnlocalizedName(References.MOD_ID + ".yellowdiamondknife");
