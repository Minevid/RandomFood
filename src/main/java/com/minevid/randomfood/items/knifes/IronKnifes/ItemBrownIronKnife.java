 ...
 */
public class ItemBrownIronKnife extends Item {

    public ItemBrownIronKnife(){
        setRegistryName("brownironknife");
        setUnlocalizedName(References.MOD_ID + ".brownironknife");
