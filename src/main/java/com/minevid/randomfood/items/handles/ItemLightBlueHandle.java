 ...
 */
public class ItemLightBlueHandle extends Item {
    public ItemLightBlueHandle(){
        setRegistryName("lightbluehandle");
        setUnlocalizedName(References.MOD_ID + ".lightbluehandle");
